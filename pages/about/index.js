    ...
    <>
      ...
      <section className="min-h-screen py-8 sm:py-12 px-4 sm:px-6 max-w-6xl mx-auto">
        <div className="lg:grid lg:grid-cols-12 lg:gap-10 xl:gap-14">
          ...
          <div className="lg:col-span-4">
            ...
            >
              <div className="relative group w-full max-w-sm mx-auto lg:max-w-none">
                <div className="absolute -inset-1.5 bg-gradient-to-tr from-red-600 rounded-2xl blur-md opacity-30 group-hover:opacity-50 transition duration-500" />
                <div className="relative rounded-2xl overflow-hidden bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl font-mono">
                  {/* Window titlebar */}
                  <div className="flex items-center justify-between px-3.5 py-2.5 bg-slate-100 dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800">
                    <div className="flex items-center gap-1.5">
                      <span className="w-2.5 h-2.5 rounded-full bg-[#ff5f56]" />
                      <span className="w-2.5 h-2.5 rounded-full bg-[#ffbd2e]" />
                      <span className="w-2.5 h-2.5 rounded-full bg-[#27c93f]" />
                    </div>
                    <span className="text-[10px] text-slate-400 dark:text-slate-500 font-semibold">profile.jpg</span>
                    <span className="w-8" />
                  </div>
          ...
          <div className="lg:col-span-8 mt-10 lg:mt-0 space-y-16">
            {/* Bio & Narrative */}
            <motion.div
